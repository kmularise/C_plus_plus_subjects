...
void change_events(vector<struct kevent>& change_list, uintptr_t ident,
      ...
      if (curr_event->flags & EV_ERROR) {
        ...
        if (curr_event->ident == server_socket) {
          ...
          if (n <= 0) {
            ...
            cout << "received data from " << curr_event->ident << ": "
                 << clients[curr_event->ident] << endl;
            cout << clients[curr_event->ident].size() << std::endl;
          }
        }
